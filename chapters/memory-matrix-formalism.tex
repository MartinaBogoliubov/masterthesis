...
\end{align}
%
Regarding the complex conjugated of the expectation value in the Liouville space and using $\mel{n}{\mt{A}_{j}^{\dag}(t)}{m}^{*} = \mel{m}{\mt{A}_{j}(t)}{n}$ let us find instantly the first condition.
...
%
\begin{align}
	\mt{P} = \sum\limits_{i,j} \oket{\mt{C}_{i}} \obraket{\mt{C}_{i}}{\mt{C}_{j}}^{-1} \obra{\mt{C}_{j}}.
