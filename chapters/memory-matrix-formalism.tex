...
\begin{align}
	...
	\notag \\
	\Leftrightarrow\ &\omega \sum\limits_{l} \delta_{il} \mathcal{C}_{lj}(\omega) = i \beta \chi_{ij}(0) + \sum\limits_{l} \Big[\Omega_{il} -i \Sigma_{il}(\omega)\Big]  \mathcal{C}_{lj}(\omega)
	\notag \\
	\Leftrightarrow\ &\sum\limits_{l} \Big[\omega \delta_{il} - \Omega_{il} + i \Sigma_{il}(\omega)\Big] \mathcal{C}_{lj}(\omega) = i \beta \chi_{ij}(0)
...
%
\begin{align}
	\Omega_{il} = i \beta \obraket{\dot{\mt{A}}_{i}}{\mt{A}_{k}} \chi_{kl}^{-1}(0).
	\label{eq: Omega}
\end{align}
%
...
\label{eq: time reversal symmetry}
%
%
