...
\begin{figure}[t]
	\centering
	\subfigure[Behaviour of the integrand in \eqref{eq:figure behaviour integrand}]{\includegraphics[width=0.49\textwidth]{behaviour_integrand.pdf}}
	\subfigure[Power dependence of the squared brackets multiplied by $\flatfrac{1}{x^{3}}$ in \eqref{eq:figure behaviour integrand}]{\includegraphics[width=0.49\textwidth]{dependence_integrand.pdf}}
	\caption{
