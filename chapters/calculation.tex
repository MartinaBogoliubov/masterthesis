...
\begin{align}
	\mt{I}_{MS}(\omega_{l}) := 
		\frac{1}{\beta} \sum\limits_{\substack{n \neq 0 \\ n \neq l}} \mathcal{D}_{\mu,\vb{k}}(\omega_{n}) \, \mathcal{D}_{\mu,\vb{k}'}(\omega_{l}-\omega_{n})
		=
		\oint\limits_{\Gamma} \frac{\dd{z}}{2\pi i} n_{\mt{B}}(z) \mathcal{D}_{\mu,\vb{k}}(z) \, \mathcal{D}_{\mu,\vb{k}'}(\omega_{l}-z)
\end{align}
%
where the momentum index is writen as an index until the Matsubara sum is evaluated and $n_{\mt{B}}(z)$ is the Bose distribution.
...
\begin{align}
	\mt{I}_{MS}(\omega_{l}) &= 
		\int\limits_{-\infty}^{\infty} \frac{\dd{\epsilon}}{2\pi i} 
			\mathcal{D}_{\mu,\vb{k}'}(\omega_{l}-\epsilon)
			\bigg[
		...
		\notag \\ &+
		\int\limits_{-\infty}^{\infty} \frac{\dd{\epsilon}}{2\pi i} 
			\mathcal{D}_{\mu,\vb{k}}(\epsilon + i\omega_{l})
			\bigg[
