...
\setlength{\parindent}{2em} 		% Indent ist set to the given value
...
\usepackage[disable]{todonotes}   	% draft: notes showed, disable: not showed
...
\usepackage{csquotes}
\usepackage[colorlinks=false, linkcolor=black, citecolor=black, urlcolor=blue, pdfborder={0 0 0}]{hyperref}
%\usepackage{hyperref}
...
\input{misc/titlepage_german}		% titlepage in german
...
\cleardoublepage
\input{misc/acknowledgements}		% help from colleagues and friends
...
%
\cleardoublepage
\input{chapters/infinite_conductivity} %done
%
\cleardoublepage
\input{chapters/spin-fermion-model} %done
%
\cleardoublepage
\input{chapters/calculation} %done
%
\cleardoublepage
\input{chapters/memory-matrix-formalism} %done
%
											%\cleardoublepage
...
\cleardoublepage
\input{chapters/appendix_propagator} %done
\input{chapters/appendix_time_derivatives} %done
								%\input{chapters/appendix_conversion_expectation_value}
\input{chapters/appendix_calculation_susceptibility} %done
\input{chapters/appendix_calculation_green} %done
\input{chapters/appendix_properties_Kubo_relaxation_function}
