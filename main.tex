...
%\newcommand{\oket*}[1]{\big|\mt{#1}\big)} % ket in operator space with no resize

\newcommand{\obra}[1]{\big({#1}\big|} % bra in operator space with automatic sizing
%\newcommand{\obra*}[1]{\big(\mt{#1}\big|} % bra in operator space with no resize

\newcommand{\obraket}[2]{\big({#1}\big|{#2}\big)} % braket in operator space with automatic sizing
\newcommand{\odyad}[2]{\oket{#1}\obra{#2}}
